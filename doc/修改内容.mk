...
# ------------------------------------------------
测试用例分析：
阅读doc中的架构规范、上位机项目架构和增减测试用例教程，接着阅读common文件夹中的底层代码，接着阅读multi_medi/camera_test/test_video_record_test.py，我需要你帮我做几个测试用例内容的修改以及新增一个测试用例，先不进行修改，先进行分析与规划，内容如下
修改测试用例：
---
4.  **M键录像测试**
