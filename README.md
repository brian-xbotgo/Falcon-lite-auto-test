...
- **📡 设备扫描** - 支持蓝牙和 WiFi 双模扫描，自动识别 Xb 设备
...
| 多媒体 | 记分牌&水印录制测试 | 自动 | ✅ |
| 多媒体 | 电子围栏测试 | 自动 | ✅ |
| 多媒体 | 1080P30fps视频录制测试 | 自动 | ✅ |
| 多媒体 | 2K30fps视频录制测试 | 自动 | ✅ |
| 多媒体 | 直播测试 | 人工 | ✅ |
| 硬件 | 水平电机测试 | 自动 | ✅ |
| 硬件 | 俯仰电机测试 | 自动 | ✅ |
| 系统 | SD卡检查 | 自动 | ✅ |
...
### 最新版本: v2.5 (2026-04-30)

- ✨ 新增 WiFi 扫描功能（支持 Xb 热点扫描）
- 🔄 设备连接区改为双表格堆叠（蓝牙/WiFi 独立显示）
- 🎨 UI 优化：扫描按钮分离，断开后不自动扫描
- 📦 依赖更新：新增 pywifi>=1.1.12 和 comtypes>=1.1.7
- 📚 文档完善：打包指南、架构规范、服务层设计

### 上一版本: v2.4 (2026-04-27)
